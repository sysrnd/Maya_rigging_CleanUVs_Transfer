...
cmds.wire( 'BS_WIRE', w='DEFORM_CURV_BOCA_SUP', gw= False, en= 1, ce= 0, li= 0, n='WIRE_BOCA_SUP' )

cmds.wire( 'BS_WIRE', w='DEFORM_CURV_BOCA_INF', gw= False, en= 1, ce= 0, li= 0, n='WIRE_BOCA_INFERIOR' )
...
cmds.select('BS_BOCA_ABIERTA_SONRISA', 'BS_BOCA_F', 'BS_BOCA_E', 'BS_BOCA_A', 'BS_BOCA_I', 'BS_BOCA_U', 'BS_BOCA_O', 'BS_BOCA_M', 'BS_BOCA_BESO', 'BS_BOCA_CHICA',
			...
			'BS_SQUASH', 'BS_CABEZA_SQUASH', 'BS_CABEZA_STRETCH', 'BS_VACIO1', 'BS_VACIO2', 'BS_VACIO3', 'BS_VACIO4', 'BS_WIRE', 
			'BS_ROOT')
...
cmds.editDisplayLayerMembers( 'no_tocar', 'IK_BRAZO_IZQ', 'IK_BRAZO_DER', 'IK_TALON_IZQ', 'IK_TALON_DER',
 	'IK_PIE_IZQ', 'IK_PIE_DER', 'IK_DEDOS_PIE_IZQ', 'IK_DEDOS_PIE_DER', 'CLR_CODO_IZQ_1', 'CLR_CODO_IZQ_2',
  	...
  	'BS_BOCA_SMIRK_IZQ','BS_STRETCH', 'BS_SQUASH','BS_CABEZA_SQUASH', 'BS_CABEZA_STRETCH','BS_VACIO1', 'BS_VACIO2',
